package com.skt.tango_rpa.service;
...
import com.skt.tango_rpa.core.RpaExecutor;
...
public class RpaService {
    ...
    public String run(RpaRequest request) {
        log.info("🧠 실행 분기 처리 - type: {}, filename: {}, count: {}",
        ...
        if (count == 1) {
            ...
            executeMultiple(count, request, executor);
            return "✅ " + count + "개 병렬 실행을 시작했습니다.";
        }
    }
